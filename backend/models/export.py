...
def eval():
    ...
    for param in pruned_params:
        if 'yolo_block.0.' in param:
            ...
            pruned_ratios.append(0.7)
        elif 'yolo_block.2.' in param:
            pruned_ratios.append(0.8)
        else:
    ...
    fluid.io.save_inference_model(cfg.freezed_model, ['image','image_shape'], outputs, exe, train_program,model_filename='completed_model', params_filename='completed_params')
