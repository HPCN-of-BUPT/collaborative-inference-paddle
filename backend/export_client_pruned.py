...
def eval_client_pruned(filepath):
    ...
    fluid.io.save_inference_model(filepath, ['image'], outputs, exe, train_program,model_filename='client_infer_pruned.pdmodel', params_filename='client_infer_pruned.pdiparams')
